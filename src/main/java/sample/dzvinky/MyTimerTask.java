...
public class MyTimerTask implements Runnable {
    ...
    File f = new File("D:\\Програмированиe\\dzvinky\\src\\main\\resources\\sample\\dzvinky\\assets\\bd\\dzvinky.txt");
    FileReader fr;
...
//    Зчитування муз файлу
    ...
    {
        try {
            muzicDzvinok = new FileInputStream("D:\\Програмированиe\\dzvinky\\src\\main\\resources\\sample\\dzvinky\\assets\\mp\\dzvinokUrok.mp3");
        } catch (FileNotFoundException e) {
            e.printStackTrace();
    ...
    FileInputStream musicPererva;

    {
        try {
            musicPererva = new FileInputStream("D:\\Програмированиe\\dzvinky\\src\\main\\resources\\sample\\dzvinky\\assets\\mp\\dzvinokPererva.mp3");
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
    }
    ...
    public void run() {
        ...
        }else if(StartMuzUrokHours.equals(startDzvinok2)){
            try {
                DzvinoknaUrok.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(startDzvinok3)){
            try {
                DzvinoknaUrok.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(startDzvinok4)){
            try {
                DzvinoknaUrok.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(startDzvinok5)){
            try {
                DzvinoknaUrok.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(startDzvinok6)){
            try {
                DzvinoknaUrok.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(startDzvinok7)){
            try {
                DzvinoknaUrok.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(startDzvinok8)){
            try {
                DzvinoknaUrok.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(endUrok1)){
            try {
                playerPererva.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(endDzvinok2)){
            try {
                playerPererva.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(endDzvinok3)){
            try {
                playerPererva.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(endDzvinok4)){
            try {
                playerPererva.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(endDzvinok5)){
            try {
                playerPererva.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(endDzvinok6)){
            try {
                playerPererva.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(endDzvinok7)){
            try {
                playerPererva.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
            }
        }else if(StartMuzUrokHours.equals(endDzvinok8)){
            try {
                playerPererva.play(1000000);
            } catch (JavaLayerException e) {
                e.printStackTrace();
